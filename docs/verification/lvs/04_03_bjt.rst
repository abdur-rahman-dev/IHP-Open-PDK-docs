...
.. list-table:: HBT NPN13G2 Bipolar Specifications
   ...
   * - Property
     - Value
   * - Description
     - npn SiGe:C HBT high performance device, 350 GHz fT. Layout configuration CBE
   * - Device Recognition
   ...
   * - Parameters
     - we, le, AE, PE, Nx, m
   * - Netlist Syntax
     - `Q1 C B E sub! npn13G2 le=900.0n we=70.00n Nx=1 m=1`
...
.. list-table:: Schematic and LVS views Compatibility for npn13G2 Parameters
   ...
   * - Nx
     ...
     - ✅
   * - m
     - Number of BJT devices (multiplicity)
     - ✅
     - ✅
     - ✅
